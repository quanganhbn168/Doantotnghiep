                ...
                <div class="card-body">
                    @isset($url)
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Tên công ty') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="website" class="col-md-4 col-form-label text-md-right">{{ __('Website công ty') }}</label>
